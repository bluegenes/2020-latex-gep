...
\section*{Workflows and Automation} % title needs to convey that Bioinformatics == Workflows (bioinfo is made up of workflows, whether you use workflow software or not)
