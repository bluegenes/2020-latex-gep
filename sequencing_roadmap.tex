...
When a step fails, and it optionally continues with independent steps.
...
These shortcomings are magnified when executing workflows on large-scale sequencing commendium.
