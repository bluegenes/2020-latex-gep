...
Bioinformatic files can take up a lot of space, and often need to be transferred from one computer to another. 
It's becoming common practice for tools to work on compressed data (gzip, bzip2, BAM/CRAM, etc) in order to save space.
...
MD5sums can be used to check integrity of a file after transfer.
...
Some programs automate file transfer and storage and check for issues with file completion and corruption. 
...
% NTP: tbh, this section includes our rec's on "project organization" - does title need to reflect that? Maybe it was fine as it was? IDK
% TER Does this still? I think we should remove project organization from the title...its confusing, esp with the data org and 
% management that's already included above
...
Consistent, descriptive names keep your project organized and interprettable for yourself and collaborators. 
