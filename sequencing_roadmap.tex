...
Data refers to raw sequencing data, metadata, intermediate files, and results files from an analysis.
Each data type contains important information that may need to be accessed at some later point.
...
Metadata accompany raw sequencing data and record experimental and sequencing information about the sample.
...
Some metadata is usually provided alongside raw sequencing data such as submitter’s sample name and library preparation. 
However, experimental metadata is often recorded in the paper that published the data. 
...
Sometimes its possible to work on a system where the data are already available, circumventing time and effort required for downloading and moving the data.
...
The recommendations above detail practices for organizing, moving, and safegaurding data. Below, we discuss recommended tools that can facilitate data transfer and storage. 
